      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
        ...
        <div className="lg:col-span-6 flex flex-col">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="w-8 h-[1px] bg-[#4062BF]/60" />
          </div>
          ...
          <div className="flex flex-col mt-2">
            ...
            <h2 className="font-orbitron font-extrabold text-[38px] sm:text-[48px] lg:text-[54px] tracking-tight leading-[0.92] text-[#4062BF] uppercase">
              THE COMMUNITY
            </h2>
          </div>
          ...
          {/* Stats Box Card */}
          <div className="rounded-2xl border border-[#4062BF]/30 bg-[#07090e]/60 p-4 sm:p-5 backdrop-blur-md shadow-md mt-5">
            <div className="grid grid-cols-4 gap-2 divide-x divide-white/10">
              ...
              <div className="flex flex-col items-center text-center gap-1.5 px-1">
                <Users className="w-5 h-5 text-[#4062BF]" />
              ...
              {/* Stat 2 */}
              <div className="flex flex-col items-center text-center gap-1.5 px-1">
                <Lightbulb className="w-5 h-5 text-[#4062BF]" />
              ...
              {/* Stat 3 */}
              <div className="flex flex-col items-center text-center gap-1.5 px-1">
                <Calendar className="w-5 h-5 text-[#4062BF]" />
              ...
              {/* Stat 4 */}
              <div className="flex flex-col items-center text-center gap-1.5 px-1">
                <TrendingUp className="w-5 h-5 text-[#4062BF]" />
          ...
          <div className="flex flex-col gap-3 mt-5">
            <div className="flex items-center gap-2.5">
              <span className="font-orbitron font-semibold text-[10px] tracking-[0.2em] text-[#4062BF] uppercase">
                CONNECT WITH US
              </span>
              <div className="w-8 h-[1px] bg-[#4062BF]/60" />
            </div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 w-full">
              {/* Instagram */}
              <a href="https://instagram.com/mulearn.sbc" target="_blank" rel="noopener noreferrer" className="rounded-xl border border-white/10 bg-[#0b0c10]/70 hover:border-[#4062BF]/50 hover:bg-[#4062BF]/10 p-2.5 flex flex-col items-center text-center gap-1.5 transition-all duration-300 group">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-[#4062BF] group-hover:text-white transition-colors shrink-0">
              ...
              {/* LinkedIn */}
              <a href="https://linkedin.com/company/mulearn-sbc" target="_blank" rel="noopener noreferrer" className="rounded-xl border border-white/10 bg-[#0b0c10]/70 hover:border-[#4062BF]/50 hover:bg-[#4062BF]/10 p-2.5 flex flex-col items-center text-center gap-1.5 transition-all duration-300 group">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-[#4062BF] group-hover:text-white transition-colors shrink-0">
              ...
              {/* YouTube */}
              <a href="https://youtube.com/@mulearn-sbc" target="_blank" rel="noopener noreferrer" className="rounded-xl border border-white/10 bg-[#0b0c10]/70 hover:border-[#4062BF]/50 hover:bg-[#4062BF]/10 p-2.5 flex flex-col items-center text-center gap-1.5 transition-all duration-300 group">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-[#4062BF] group-hover:text-white transition-colors shrink-0">
              ...
              {/* Discord */}
              <a href="https://discord.gg/your-invite" target="_blank" rel="noopener noreferrer" className="rounded-xl border border-white/10 bg-[#0b0c10]/70 hover:border-[#4062BF]/50 hover:bg-[#4062BF]/10 p-2.5 flex flex-col items-center text-center gap-1.5 transition-all duration-300 group">
                <div className="w-4 h-4 text-[#4062BF] group-hover:text-white transition-colors shrink-0 flex items-center justify-center">
              ...
              {/* Email */}
              <a href="mailto:mulearnsbc@gmail.com" className="rounded-xl border border-white/10 bg-[#0b0c10]/70 hover:border-[#4062BF]/50 hover:bg-[#4062BF]/10 p-2.5 flex flex-col items-center text-center gap-1.5 transition-all duration-300 group">
                <Mail className="w-4 h-4 text-[#4062BF] group-hover:text-white transition-colors shrink-0" />
              ...
              {/* Website */}
              <a href="https://mulearn-sbc.vercel.app" target="_blank" rel="noopener noreferrer" className="rounded-xl border border-white/10 bg-[#0b0c10]/70 hover:border-[#4062BF]/50 hover:bg-[#4062BF]/10 p-2.5 flex flex-col items-center text-center gap-1.5 transition-all duration-300 group">
                <Globe className="w-4 h-4 text-[#4062BF] group-hover:text-white transition-colors shrink-0" />
        ...
        <div className="lg:col-span-6 flex flex-col gap-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pt-2">
            <p className="font-sans font-light text-[13px] sm:text-[13.5px] leading-relaxed text-white/70 max-w-md">
              The <strong className="text-[#4062BF] font-medium">µLearn Campus Chapter</strong> at Sree Buddha College of Engineering helps student developers learn by building, collaborating, and launching real-world solutions.
            </p>
            ...
            <motion.a
              ...
              className="inline-flex items-center justify-center py-2.5 px-6 border border-[#4062BF] bg-[#4062BF]/10 hover:bg-[#4062BF]/20 text-white font-orbitron text-[11px] font-bold tracking-widest uppercase transition-all duration-300 rounded-none shrink-0 gap-2 shadow-sm"
              whileHover={{ y: -2 }}
            >
