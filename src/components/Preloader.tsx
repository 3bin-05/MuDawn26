...
const TELEMETRY_LINES = [
  'INITIALIZING μDAWN MAINFRAME...',
  'ESTABLISHING SECURE PROTOCOLS...',
  'DECRYPTING DATABASE [μDAWN_2026]...',
  'SYNCHRONIZING AI GRID MODULES...',
  'GRID SYNCHRONIZATION 100%...',
  'μDAWN COMPILATION ONLINE.'
];
      ...
      {!isCompleted && (
        ...
        >
          ...
          <div className="text-center mb-6">
            <h1 className="font-orbitron font-extrabold text-[18px] sm:text-[22px] tracking-[0.25em] text-white">
              μLEARN SBC | μDAWN ’26
            </h1>
